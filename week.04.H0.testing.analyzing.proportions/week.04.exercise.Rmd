...
#prob under X: 0.061.
# prrob under 15%: 1.149
# total x chr: 382
# x chr under 15% : 58
binom.test(58, 382, 0.061, alternative = "greater")
```
Answer: The null hypothesis is that the X chromozone has a higher proportion of genes in the lower 15%. Having a total of 328 genes under the X chromozone, of which 58 are under the 15%. we use the binomial test, and get a  p-value = 1.945e-10, which is low enough that the null hypothesis holds.
...
# total x chr: 382
# x chr under 5% : 20
binom.test(20, 382, 0.021, alternative = "greater")
```

As we can see, the p value greatly increasead so we cannot say that our null hypothesis still holds.
...
library(tidyverse)
mammals = read_csv(file = "C:/Users/Stine/Dropbox/Bioinformatics/Data science in bioinformatics/datascifi_cornflowerblue/datasets/dataset.01.rsbl20150010supp1.csv")
